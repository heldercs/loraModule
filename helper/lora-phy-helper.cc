  ...
  if (typeId == "ns3::SimpleGatewayLoraPhy")
    {
      ...
      // 1 ReceivePaths on 867.1
      // 1 ReceivePaths on 867.3
      // 1 ReceivePaths on 867.5
      // 1 ReceivePaths on 867.7
      // 1 ReceivePaths on 867.9
      // 1 ReceivePaths on 868.1
      // 1 ReceivePaths on 868.3
      // 1 ReceivePaths on 868.5
